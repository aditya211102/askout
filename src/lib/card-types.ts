...
export const STICKERS: Record<StickerType, { emoji: string; name: string; premium?: boolean; image?: string }> = {
  heart: { emoji: '💖', name: 'Heart', image: '/stickers/heart.png' },
  rose: { emoji: '🌹', name: 'Rose', image: '/stickers/rose.png' },
  cupid: { emoji: '💘', name: 'Cupid Arrow', image: '/stickers/cupid.png' },
  sparkle: { emoji: '✨', name: 'Sparkle', image: '/stickers/sparkle.png' },
  kiss: { emoji: '💋', name: 'Kiss', image: '/stickers/kiss.png' },
  ring: { emoji: '💍', name: 'Ring', premium: true, image: '/stickers/ring.png' },
  letter: { emoji: '💌', name: 'Love Letter', image: '/stickers/letter.png' },
  teddy: { emoji: '🧸', name: 'Teddy Bear', image: '/stickers/teddy.png' },
  'love-bear': { emoji: '🐻', name: 'Love Bear', image: '/stickers/love-bear.png' },
  'cute-cat': { emoji: '🐱', name: 'Cute Cat', image: '/stickers/cute-cat.png' },
  'heart-bunny': { emoji: '🐰', name: 'Heart Bunny', image: '/stickers/heart-bunny.png' },
  'dancing-hearts': { emoji: '💞', name: 'Dancing Hearts', premium: true, image: '/stickers/dancing-hearts.png' },
  'kissy-bear': { emoji: '🐻‍❄️', name: 'Kissy Bear', premium: true, image: '/stickers/kissy-bear.png' },
  'hug-bears': { emoji: '🤗', name: 'Hug Bears', premium: true, image: '/stickers/hug-bears.png' },
  'love-penguin': { emoji: '🐧', name: 'Love Penguin', premium: true, image: '/stickers/love-penguin.png' },
  'roses-for-you': { emoji: '💐', name: 'Roses For You', premium: true, image: '/stickers/roses-for-you.png' },
};
